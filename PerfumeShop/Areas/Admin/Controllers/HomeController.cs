...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Index(int ?page,string SearchString = "")
        {
            ...
            if (SearchString != "")
            {
                var sp = db.Sanphams.Where(x => x.Tensp.ToUpper().Contains(SearchString.ToUpper())).OrderBy(x => x.Masp); 
        ...
        public ActionResult Create()
        {
            ...
            var loaiselected = new SelectList(db.Danhchokhs, "MaLoai", "Tenloai");
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.Mahang = hangselected;
            var loaiselected = new SelectList(db.Danhchokhs, "Maloai", "Tenloai",dt.Maloai);
            ViewBag.Maloai = loaiselected;
           // 
            return View(dt);
